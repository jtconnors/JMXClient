...
#
Set-Variable -Name PROJECT -Value JMXClient
Set-Variable -Name VERSION -Value "jdk17"
Set-Variable -Name MAINJAR -Value "$PROJECT-$VERSION.jar"
Set-Variable -Name LATENCIES_MAINCLASS -Value com.example.latencies.Latencies
Set-Variable -Name JMX_REMOTE_AUTHENTICATE -Value "false"
Set-Variable -Name PORT -Value 9999
Set-Variable -Name JMX_REMOTE_SSL -Value "false"
Set-Variable -Name JFR_NAME -Value "default"
Set-Variable -Name JFR_FILENAME -Value "Latencies.jfr"
...
# For JDK 1.8, if needed?
#$jdk_version_unfiltered = $java_version_output.Split(" ")[2].substring[0..2]
#
