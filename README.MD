...
Our sample JMX scripts (see below) use the -interval and -threshold options to mimic Java Flight Recorder trigger behavior.
...
4. Run either the ```JMXClientThreadCount.ps1``` or ```JMXClientResponseTime.ps1```
